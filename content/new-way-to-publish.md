...
По всем этим причинам я решила создать отдельное хранилище для заметок, предназначенных для публикации и уже опубликованных. Это может создать определённые неудобства из-за необходимости переключаться между хранилищами, но в целом сделает процесс чище и понятнее.

Кроме того, я полагаю, в таком формате мне будет комфортнее писать посты с текущими новостями, подобные этому, и в целом я буду чувствовать себя свободнее публиковать больше заметок.